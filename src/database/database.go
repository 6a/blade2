...
CREATE INDEX email_idx ON player (email);`,
	...
	player_1_elo_start INT(16) NOT NULL DEFAULT '1200',
	player_1_elo_end INT(16) NOT NULL DEFAULT '1200',
	player_2_elo_start INT(16) NOT NULL DEFAULT '1200',
	player_2_elo_end INT(16) NOT NULL DEFAULT '1200',
